<template>
  <div class="content-blocks blog" :class="{ showx: open }">
            ...
            <div class="post">
              ...
              <div class="post-body">
                <p>
                  ...
                  Quisque aliquet neque vitae lectus tempus consectetur. Aliquam
                  erat volutpat. Nunc eu nibh nulla, id cursus arcu.
                </p>
